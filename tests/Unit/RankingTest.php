...
class RankingTest extends TestCase
{
    ...
    {
        $this->assertEquals($this->ranking->goalAgainstCountDuringAMatch(1, $this->match0), 5);
        $this->assertEquals($this->ranking->goalAgainstCountDuringAMatch(3, $this->match0), 3);
        $this->assertEquals($this->ranking->goalAgainstCountDuringAMatch(4, $this->match0), 0);
    }
    ...
    {
        $this->assertGreaterThan($this->ranking->compareRankingRow(
        ...
        $this->assertEquals($this->ranking->compareRankingRow(
            ['points' => 4, 'goal_difference' => 3, 'goal_for_count' => 2],
            ['points' => 4, 'goal_difference' => 3, 'goal_for_count' => 2]
        ), 0);
        $this->assertLessThan($this->ranking->compareRankingRow(
            ['points' => 3, 'goal_difference' => 4, 'goal_for_count' => 4],
            ['points' => 4, 'goal_difference' => 3, 'goal_for_count' => 3]
        ), 0);
        $this->assertLessThan($this->ranking->compareRankingRow(
    ...
    {
        $this->assertEquals(
            $this->ranking->sortedRanking($this->data->teams(), $this->data->matches()),
